    ...
    <main className="min-h-screen bg-[#F8FAFC] flex flex-col lg:flex-row font-sans text-slate-900">
      <div className="flex-1 p-4 lg:p-10">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Header - เวอร์ชันแก้ไขโลโก้ให้คลีนที่สุด (ไม่มีตัว M ซ้อน) */}
          <div className="flex justify-between items-center mb-8 bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg ring-4 ring-blue-50 overflow-hidden">
                <img 
                  src="/logo.png" 
                  alt="Logo" 
